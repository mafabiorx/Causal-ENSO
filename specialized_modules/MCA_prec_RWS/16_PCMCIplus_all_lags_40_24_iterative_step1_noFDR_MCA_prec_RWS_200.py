...
target_dir_results_base = get_results_path(f'MCA_prec_RWS_200/{trial}/{target_descriptor}/{VERSION}')
...
VARIABLE_SEASONS = {
    'REOF SST JJA': 'JJA', 'DMI_JJA': 'JJA', 
    'MCA WAF-RWS SON': 'SON', 'MCA prec-RWS SON': 'SON', 'SIOD_SON': 'SON',
    'MCA2 RWS-WAF DJF': 'DJF', 
...
# 'MCA2 RWS-prec DJF': 'DJF',

# Dynamically add MCA variables with the correct season
VARIABLE_SEASONS[f'MCA1_prec'] = mca_season
VARIABLE_SEASONS[f'MCA2_prec'] = mca_season
VARIABLE_SEASONS[f'MCA1_RWS_200'] = mca_season
VARIABLE_SEASONS[f'MCA2_RWS_200'] = mca_season

ALL_VARIABLES = list(VARIABLE_SEASONS.keys())

# Variable groups with dynamic MCA assignment
JJA_PREDICTORS = ['REOF SST JJA', 'DMI_JJA']
SON_PREDICTORS = ['MCA WAF-RWS SON', 'MCA prec-RWS SON', 'SIOD_SON']
DJF_CONFOUNDERS = ['MCA2 RWS-WAF DJF', 'Atl3_DJF_0', 'SASDI_DJF_0', 'NPMM_SST_DJF_0', 'WNP_DJF_0'] # 'MCA2 RWS-prec DJF', 
...
mca_variables = ['MCA1_prec', 'MCA2_prec', 'MCA1_RWS_200', 'MCA2_RWS_200']
