...
# Load first 2 MCA modes of RWS and first 2 MCA modes of WAF
# RWS modes
MCA1_RWS = xr.open_dataset(os.path.join(SAVE_DIR, 
                                f'MCA_RWS_WAF_timeseries_RWS_mode1_gen{generation}_ind{individual}.nc'))['pc_RWS']
MCA2_RWS = xr.open_dataset(os.path.join(SAVE_DIR, 
                                f'MCA_RWS_WAF_timeseries_RWS_mode2_gen{generation}_ind{individual}.nc'))['pc_RWS']

# WAF modes                              
MCA1_WAF = xr.open_dataset(os.path.join(SAVE_DIR, 
                                f'MCA_RWS_WAF_timeseries_WAF_mode1_gen{generation}_ind{individual}.nc'))['pc_WAF']
MCA2_WAF = xr.open_dataset(os.path.join(SAVE_DIR, 
                                f'MCA_RWS_WAF_timeseries_WAF_mode2_gen{generation}_ind{individual}.nc'))['pc_WAF']
