...
1. Modifies the vertices in script 2_MCA_RWS_WAF_*.py
...
START_VERSION_NUM = 0
TRIAL = 406
RESULTS_DIR = get_results_path(f'MCA_RWS_WAF/trial_{TRIAL}/')
os.makedirs(RESULTS_DIR, exist_ok=True)

INITIAL_RECT = Rect(lat_min=-35, lat_max=-15, lon_min=-40, lon_max=-25)
...
OPTIMIZED_MCA_VARS = ['MCA1_RWS', 'MCA2_RWS', 'MCA1_WAF', 'MCA2_WAF']
...
def run_optimization_step(individual_vertices: Sequence[Tuple[int, int]], 
    ...
    script2_orig_path = os.path.join(CURRENT_DIR, '2_MCA_RWS_WAF.py')
    script14_orig_path = os.path.join(CURRENT_DIR, '14_save_ds_caus_E_v_C_40_24_MCA_RWS_WAF.py')
    script16_orig_path = os.path.join(CURRENT_DIR, '16_PCMCIplus_all_lags_40_24_iterative_step1_noFDR_MCA_RWS_WAF.py')
